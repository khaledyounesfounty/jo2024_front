  ...
  return (
    ...
    ,borderRadius: '12px'
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
        ...
        <Box sx={{ flexGrow: 1 }} />
          <Button variant="contained" sx={{ borderRadius: '12px', background: 'black', color: 'white' }} size="small">
            Reserver
          </Button>
            <Button variant="contained" sx={{ borderRadius: '12px', background: 'red', color: 'white' }} size="small">
                Supprimer
            </Button>
            <Button variant="contained" sx={{ borderRadius: '12px', background: 'green', color: 'white' }} size="small">
                Supprimer
            </Button>
            </Box>
